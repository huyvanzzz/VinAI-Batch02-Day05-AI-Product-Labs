...
Vì vậy, nhóm cần bổ sung ít nhất 1-2 nguồn ngoài nhóm như phỏng vấn nhanh, review app hoặc quan sát người từng đặt lịch khám online.
...
| User nhập “đau chân 3 ngày nay, chân sưng rất nhiều”, VinmecCare chuyển sang phiếu hỗ trợ/hotline. | Self-use screenshot: `assets/z7896607636913_7888656377b674b5bd0e49de9888968c.jpg` | Handoff có tồn tại, nhưng thiếu lý do và thiếu summary cho người thật. | Output phải có draft summary khi handoff hoặc route. |
...
|---|---|---|
| A | Research / evidence | Ảnh self-use VinmecCare, bảng observation, thêm ít nhất 1 nguồn ngoài nhóm hoặc phỏng vấn nhanh. |
| B | SPEC | File `thin-spec.md`, pain statement, build slice, Auto/Aug decision, Four paths. |
| C | Prototype | UI chat intake, quick replies, logic slot-filling, màn hình gợi ý chuyên khoa và summary. |
| D | Test / failure path | Test đủ 4 paths, đặc biệt red flag case: sốt 40°C, chảy máu, khó thở/nôn ra máu; ghi kết quả test. |
| E | Demo script / repo | Script demo 3-5 phút, gom file vào repo, kiểm tra cấu trúc nộp bài và assets ảnh. |
